  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50/50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Hero Section */}
        <div className="text-center py-8 px-4 sm:py-12 sm:px-6 rounded-2xl bg-white shadow-sm border border-gray-200/80 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-amrita-blue mb-4">
              Welcome to Back2U
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/report-found">
                <Button className="bg-amrita-blue hover:bg-amrita-blue-dark text-white px-5 py-2.5 text-base sm:px-7 sm:py-3 sm:text-lg font-semibold rounded-lg shadow-lg shadow-blue-500/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5">
              ...
              <Link to="/browse-found">
                <Button variant="outline" className="border-2 border-gray-300 hover:border-amrita-blue px-5 py-2.5 text-base sm:px-7 sm:py-3 sm:text-lg font-semibold rounded-lg bg-white/80 backdrop-blur-sm hover:bg-gray-50 transition-all duration-300">
